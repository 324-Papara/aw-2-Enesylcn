...

{
    ...
    {
        var entity = await unitOfWork.CustomerRepository.Where(x => x.Id == request.CustomerId);
    ...
    {
        var entityList = await unitOfWork.CustomerRepository.Include(x => x.CustomerPhones);
